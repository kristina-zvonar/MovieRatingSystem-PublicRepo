...
namespace MovieRatingSystem.Server.Helpers.Auth
{
    public class BasicAuthenticationHandler : AuthenticationHandler<AuthenticationSchemeOptions>
    {
        ...
        protected override async Task<AuthenticateResult> HandleAuthenticateAsync()
        {
            ...
            {
                return AuthenticateResult.Fail(ErrorMessage.MISSING_HEADER);
            }
            ...
            {
                return AuthenticateResult.Fail(ErrorMessage.INVALID_HEADER);
            }

            if (user == null)
            {
                return AuthenticateResult.Fail(ErrorMessage.INVALID_CREDENTIALS);
            }
